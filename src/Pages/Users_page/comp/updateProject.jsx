...
import "../../Appointment_page/AppointmentRequest.css"
...
//     const addressString = ` ${formData.address.city}, ${formData.address.state}, ${formData.address.country}, ${formData.address.pincode}`;
