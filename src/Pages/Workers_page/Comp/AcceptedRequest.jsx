...
const AcceptedCard = ({ request, onUnaccept, onReject }) => {
  return (
    <div className="job-card">
      ...
      <div className="card-body">
        <div className="card-header">
          <div>
            ...
            <span style={{ fontSize: '0.85rem', color: '#6b7280' }}>
              Name <span style={{ color: '#f97316', fontWeight: '600' }}>{request.customerInfo[0]?.name}</span>
            </span>
          </div>
        ...
        <div style={{ display: 'flex', gap: '10px', marginTop: 'auto' }}>
          <button onClick={() => onUnaccept(request._id)} className="btn btn-reject" style={{ flex: 1, justifyContent: 'center' }}>
            Unaccept
          </button>
